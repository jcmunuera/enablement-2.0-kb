...
- **Source ERI:** eri-code-001-hexagonal-light-java-spring
- **Used by:** skill-code-020-generate-microservice-java-spring
- **Feature modules:** mod-001-circuit-breaker-java-resilience4j (for resilience feature)
...
|------------------|------------------|--------|----------|
| **JPA** (local DB) | `adapter/persistence/` | [mod-016-persistence-jpa-spring](../mod-016-persistence-jpa-spring/) | Service owns its data |
| **System API** (mainframe) | `adapter/systemapi/` | [mod-017-persistence-systemapi](../mod-017-persistence-systemapi/) | Service delegates to mainframe |
