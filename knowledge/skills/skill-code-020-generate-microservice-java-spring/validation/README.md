...
**Hexagonal Architecture (mod-015):**
- ✅ Domain layer exists
...
**Circuit Breaker (mod-001)** - if `features.circuit_breaker: true` in input JSON:
...
- **Modules:**
  ...
  - mod-001-circuit-breaker-java-resilience4j (conditional)
- **Validation Scripts:**
