...
**Modules:** 
- mod-017-persistence-systemapi-feign
- mod-018-persistence-systemapi-resttemplate
- mod-019-persistence-systemapi-restclient
...
|-------------|--------|-----|--------|
| jpa | mod-016-persistence-jpa-spring | ERI-CODE-012 | ✅ Active |
| system_api | mod-017-persistence-systemapi | ERI-CODE-012 | ✅ Active |
